                ...
                <div class="p-6">
                    <form action="{{ route('estudiantes.update', $estudiante) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="codigo" id="codigo" value="{{ old('codigo', $estudiante->codigo) }}" class="w-full border-gray-300 rounded-md shadow-sm @error('codigo') border-red-500 @enderror">
                            @error('codigo')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="apellidos" id="apellidos" value="{{ old('apellidos', $estudiante->apellidos) }}" class="w-full border-gray-300 rounded-md shadow-sm @error('apellidos') border-red-500 @enderror">
                            @error('apellidos')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nombres" id="nombres" value="{{ old('nombres', $estudiante->nombres) }}" class="w-full border-gray-300 rounded-md shadow-sm @error('nombres') border-red-500 @enderror">
                            @error('nombres')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
