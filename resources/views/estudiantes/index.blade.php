<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('estudiantes.create') }}" class="px-4 py-2 text-white rounded-md" style="background-color: #800000;">
                Nuevo Estudiante
            </a>
        </div>
    </x-slot>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr style="background-color: #F2F2F2;">
                                <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider" style="color: #333333;">Código</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($estudiantes as $estudiante)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap" style="color: #333333;">{{ $estudiante->codigo }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap" style="color: #333333;">{{ $estudiante->apellidos }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap" style="color: #333333;">{{ $estudiante->nombres }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <a href="{{ route('estudiantes.edit', $estudiante) }}" class="text-blue-600 hover:text-blue-900 mr-3">Editar</a>
